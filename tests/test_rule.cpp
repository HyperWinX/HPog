...
RightmostTerminal) {
	...
	Rule<int> rule(42, &s1, std::vector<const Symbol<int>*>{&s2, &s3, &s4}, [](Parser<int>&, auto&&) -> int { return 0; });
...
EpsilonToString) {
	Symbol<int> s1(1, SymbolKind::Nonterminal, "1");
	Rule<int> rule(42, &s1, std::vector<const Symbol<int>*>{}, [](Parser<int>&, auto&&) -> int { return 0; });
...
Equality) {
	...
	Symbol<int> s3(3, SymbolKind::Terminal, "3");
	Symbol<int> s4(4, SymbolKind::Nonterminal, "4");
	Rule<int> rule1(42, &s1, std::vector<const Symbol<int>*>{&s2, &s3, &s4}, [](Parser<int>&, auto&&) -> int { return 0; });
	Rule<int> rule2(42, &s1, std::vector<const Symbol<int>*>{}, [](Parser<int>&, auto&&) -> int { return 0; });
	Rule<int> rule3(43, &s1, std::vector<const Symbol<int>*>{&s2, &s3, &s4}, [](Parser<int>&, auto&&) -> int { return 0; });
